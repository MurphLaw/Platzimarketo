...
import com.example.ejemplospring.domain.dto.AuthenticationRequest;
import com.example.ejemplospring.domain.dto.AuthenticationResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createToken(@RequestBody AuthenticationRequest request){
        try{
            ...
            UserDetails userDetails=samUserDetailsService.loadUserByUsername(request.getUsername());
